                ...
                <header>
                    ...
                    <div>
                        ...
                        <ul style={{listStyle:'none',padding:'0'}}>
                            <li><a href="" className='link link-light link-underline-opacity-0 link-underline-opacity-100-hover' ><img src={github_icon} alt="Github" className='git_icon' />  My Github</a></li>
